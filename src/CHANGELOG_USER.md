...
- **Never suspend this group**: mark a tab group and its tabs are left alone however long you leave them, which is handy for monitoring or dashboard tabs. Give the group a name first (the right-click item stays greyed out until you do), then set it from the right-click menu; review the list in Options.
