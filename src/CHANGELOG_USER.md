...
- **Never suspend this group**: mark a tab group and its tabs are left alone however long you leave them, which is handy for monitoring or dashboard tabs. Set it from the right-click menu; review the list in Options.
