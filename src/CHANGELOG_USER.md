...
- **"Never suspend tabs in a tab group"**: a new option (off by default) that keeps any tab belonging to a Chrome tab group out of automatic suspension, without you having to whitelist each site in it.
